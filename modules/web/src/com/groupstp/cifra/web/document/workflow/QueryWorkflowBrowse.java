...
import com.groupstp.cifra.web.document.workflow.frame.QueryWorkflowBrowseTableFrame;
...
/**
 * Document entity browser screen which using special for workflow extension
 *
 * @author adiatullin
 */
public class QueryWorkflowBrowse extends AbstractLookup {
    ...
    private Component createTab(@Nullable Stage stage) {
        return openFrame(null, "query-workflow-table",
