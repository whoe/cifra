...
create unique index IDX_CIFRA_DOC_TYPE_UNIQ_NAME on CIFRA_DOC_TYPE (NAME) ^
-- end CIFRA_DOC_TYPE
...
create unique index IDX_CIFRA_EMPLOYEE_UNIQ_USER_ID on CIFRA_EMPLOYEE (USER_ID) ^
create index IDX_CIFRA_EMPLOYEE_ON_USER on CIFRA_EMPLOYEE (USER_ID)^
-- end CIFRA_EMPLOYEE
-- begin CIFRA_COMPANY
create unique index IDX_CIFRA_COMPANY_UNIQ_NAME on CIFRA_COMPANY (NAME) ^
create unique index IDX_CIFRA_COMPANY_UNQ on CIFRA_COMPANY (EXTERNAL_ID) ^
-- end CIFRA_COMPANY
...
-- end CIFRA_JOURNAL
-- begin CIFRA_TAG
create unique index IDX_CIFRA_TAG_UNIQ_NAME on CIFRA_TAG (NAME) ^
-- end CIFRA_TAG
