...
alter table CIFRA_DIVISION add constraint FK_CIFRA_DIVISION_ON_COMPANY foreign key (COMPANY_ID) references CIFRA_COMPANY(ID)^
create index IDX_CIFRA_DIVISION_ON_COMPANY on CIFRA_DIVISION (COMPANY_ID)^
-- end CIFRA_DIVISION
